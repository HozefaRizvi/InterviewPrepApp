...
def add_crm_questions(): 
    try:
        ...
        json_file_path = r'C:\Users\TechEnclave Computer\Desktop\NewBackend\BluePrints\QuestionBankBluePrints\QuestionDataBase\CRMDATA.json'
...
def add_devops_questions():
    try:
        # Load JSON data from the file
        json_file_path = r'C:\Users\TechEnclave Computer\Desktop\NewBackend\BluePrints\QuestionBankBluePrints\QuestionDataBase\DevopsData.json'
        with open(json_file_path, "r") as file:
            crm_data = json.load(file)
...
def add_quality_questions():
    try:
        # Load JSON data from the file
        json_file_path = r'C:\Users\TechEnclave Computer\Desktop\NewBackend\BluePrints\QuestionBankBluePrints\QuestionDataBase\QualityAssuranceData.json'
        with open(json_file_path, "r") as file:
            crm_data = json.load(file)
...
def add_security_questions():
    try:
        # Load JSON data from the file
        json_file_path = r'C:\Users\TechEnclave Computer\Desktop\NewBackend\BluePrints\QuestionBankBluePrints\QuestionDataBase\SecurityData.json'
        with open(json_file_path, "r") as file:
            crm_data = json.load(file)
...
def add_softwareintegration_questions():
    try:
        # Load JSON data from the file
        json_file_path = r'C:\Users\TechEnclave Computer\Desktop\NewBackend\BluePrints\QuestionBankBluePrints\QuestionDataBase\SoftwareIntegrationData.json'
        with open(json_file_path, "r") as file:
            crm_data = json.load(file)
